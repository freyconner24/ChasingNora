  ...
  render: function() {
    return (
	    React.createElement("div", {className: "block peachBack white textCenter bigBelle"}, 
	        ...
	        React.createElement("a", {href: "https://soundcloud.com/polarmusicstudios"}, React.createElement("div", {className: "myButtonMarv white textCenter centerBlock darkPeachBack", onClick: this.downlodMarvinsRoom}, "download"))
	    )
    );
  },
