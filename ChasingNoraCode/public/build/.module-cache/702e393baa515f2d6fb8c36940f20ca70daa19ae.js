  ...
  render: function() {
    return (
	    React.createElement("div", {className: "block peachBack white textCenter bigBelle"}, 
	        ...
	        React.createElement("a", {href: "download/Marvin's Room.mp3"}, React.createElement("div", {className: "myButtonMarv white textCenter centerBlock darkPeachBack"}, "download"))
	    )
    );
  }
});
