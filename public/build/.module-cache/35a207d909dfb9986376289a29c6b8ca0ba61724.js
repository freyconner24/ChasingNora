    ...
    return (
        React.createElement("div", {className: "myFooter peachBack textCenter"}, 
            React.createElement("div", {className: "footerLinks"}, 
                ...
                React.createElement("div", {className: "headerItem inlineBlock"}, React.createElement("a", {href: "https://polarmusicstudios.com/view/"}, "website")), 
            ...
            React.createElement("div", {className: "sqs-block-content"}, 
                React.createElement("div", {className: "josefin"}, "Site by ", React.createElement("a", {href: "https://www.linkedin.com/in/connerfrey", style: style}, "Conner Frey"), " · Music Recoded At ", React.createElement("a", {className: "blackLink", href: "https://polarmusicstudios.com", style: style}, "Polar Music Studios")
                )
            )
        )
    );
